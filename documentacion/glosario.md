...
- JWT: Token JSON Web firmado; incluye claims como userId y roles.
...
- @PreAuthorize: Anotación de Spring para verificar roles/authorities antes de ejecutar endpoints.
