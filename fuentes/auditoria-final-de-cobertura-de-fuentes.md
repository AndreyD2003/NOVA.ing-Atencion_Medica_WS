# Auditoría final de cobertura de Fuentes
...
* [Ejemplos rápidos de verificación](../web-semantica/limites-y-restricciones-actuales.md)
...
* [Límites y restricciones actuales](../arquitectura/ejemplos-rapidos-de-verificacion.md)

#### `01 Guia Web Semantica Para Principiantes`

Cubierto en:

* [Objetivo y recorrido recomendado](../flujos/mapa-rapido-de-clases-involucradas.md)
...
* [Mapa rápido de clases involucradas](../web-semantica/objetivo-y-recorrido-recomendado.md)
...
* [Paciente (msvc-paciente)](paciente-msvc-paciente.md)

#### `msvc medico`

Cubierto en:

* [Médico (msvc-medico)](medico-msvc-medico.md)

#### `msvc cita`

Cubierto en:

* [Cita (msvc-cita)](cita-msvc-cita.md)

#### `msvc diagnostico`

Cubierto en:

* [Diagnóstico (msvc-diagnostico)](diagnostico-msvc-diagnostico.md)

#### `msvc web semantica`

Cubierto en:

* [msvc-web-semantica](msvc-web-semantica-1.md)
* [Consultas y ejemplos](../web-semantica/modulo-semantico/consultas-y-ejemplos.md)
...
`Fuentes` puede eliminarse cuando quieras hacer la limpieza final.
