...
import org.nova.ing.springcloud.atencion.medica.msvc.paciente.config.FeignInterceptorConfig;
...
@FeignClient(name = "msvc-diagnostico", url = "http://localhost:8082/diagnosticos", configuration = FeignInterceptorConfig.class)
